...
export type PostManyWhereInput = {
  ...
  /** All values that are contained in given list. */
  language_in?: InputMaybe<Array<Languages>>;
  /** All values that are not equal to given value. */
  language_not?: InputMaybe<Languages>;
  /** All values that are not contained in given list. */
  language_not_in?: InputMaybe<Array<Languages>>;
  publishedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  publishedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export type AllPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', title: string, id: string, slug: string, publishedAt?: any | null, language: Languages, content: { __typename?: 'RichText', html: string } }> };
